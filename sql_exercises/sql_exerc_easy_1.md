...
The second, shorter version will generate a name for the constaint whereas the first version we have given the constraint the name `check_age`.
...
First, make sure to connect to a different database.
